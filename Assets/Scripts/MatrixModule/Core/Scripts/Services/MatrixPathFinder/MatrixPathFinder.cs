    ...
    public class MatrixPathFinder : IMatrixPathFinder
    {
        ...
        public List<Vector2Int> PathFinding<TMatrixEntity>(IMatrix<TMatrixEntity> matrix, Vector2Int startPosition, Vector2Int endPosition, Predicate<TMatrixEntity> predicate = null) {
            ...
            while (openList.Count > 0) {
                ...
                if (!NeighborValidator(matrix, currentNode, predicate, openList, end))
        ...
        private bool NeighborValidator<TMatrixEntity>(IMatrix<TMatrixEntity> matrix, Node currentNode, Predicate<TMatrixEntity> predicate, List<Node> openList, Node end) {
